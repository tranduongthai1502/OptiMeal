...
void main() {
  ...
  group('Smart Recipe Copilot Tests', () {
    test('should fetch cold storage ingredients and identify short-expiry items (< 24h)', () async {
    ...
    test('should prioritize recipes utilizing short-expiry ingredients', () async {
      final result = await repository.generateBatchRecipes(targetPortions: 150);
    ...
    test('should scale ingredient quantities according to target portions', () async {
      final result100 = await repository.generateBatchRecipes(targetPortions: 100);
      final result200 = await repository.generateBatchRecipes(targetPortions: 200);
