            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Thông tin hoạt động', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  const SizedBox(height: 12),
                  const ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(Icons.access_time_rounded, color: AppColors.primary),
                    title: Text('Giờ mở cửa: 06:30 - 22:00'),
                    subtitle: Text('Khung giờ đăng thực phẩm dư: 19:30 - 21:00 hàng ngày'),
                  ),
                  const ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: Icon(Icons.location_on_outlined, color: AppColors.primary),
                    title: Text('180 Hai Bà Trưng, Phường Đa Kao, Quận 1, TP.HCM'),
                  ),
